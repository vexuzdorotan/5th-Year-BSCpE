...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2019 at 01:19 PM
...
INSERT INTO `section` (`SectionName`, `GradeLevel`, `RoomNum`, `SectionNum`, `Adviser`, `Population`) VALUES
('Marangal', 'Grade 7', 107, 4, NULL, 0),
('Matapang', 'Grade 7', 108, 13, NULL, NULL);

--
-- Triggers `section`
--
DELIMITER $$
CREATE TRIGGER `AFTER INSERT section` AFTER INSERT ON `section` FOR EACH ROW UPDATE teacher, section SET teacher.SectionNum = section.SectionNum WHERE teacher.SectionNum IS NOT NULL
$$
DELIMITER ;
DELIMITER $$
...
--
ALTER TABLE `employee`
  MODIFY `EmployeeNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `section`
--
ALTER TABLE `section`
  MODIFY `SectionNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
ALTER TABLE `section`
  ...
  ADD CONSTRAINT `section_ibfk_2` FOREIGN KEY (`Adviser`) REFERENCES `teacher` (`Name`) ON DELETE SET NULL ON UPDATE CASCADE;
