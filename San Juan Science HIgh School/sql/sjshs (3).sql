...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2019 at 02:54 AM
...
--
DELIMITER $$
CREATE TRIGGER `AFTER INSERT section` AFTER INSERT ON `section` FOR EACH ROW UPDATE teacher SET SectionNum = section.SectionNum WHERE SectionNum IN (SELECT SectionNum FROM room WHERE Adviser IS NOT NULL)
$$
DELIMITER ;
