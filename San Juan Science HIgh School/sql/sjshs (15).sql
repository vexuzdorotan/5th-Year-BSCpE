...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2019 at 09:26 AM
...
INSERT INTO `employee_backup` (`EmployeeNum`, `LastName`, `FirstName`, `MiddleName`, `Birthday`, `Age`, `Street_Address1`, `Street_Address2`, `City`, `Province`, `Country`, `Gender`, `Position`, `URL_Picture`, `DateRegistered`, `DateCreated`) VALUES
(1, 'Gabon', 'Jose Mari', 'Manuel', '1997-03-28', 22, '#4083 V. Baltazar', 'Pinagbuhatan', 'Pasig', 'Metro Manila', 'Philippines', 'Male', 'Teacher', '../pictures/employee/lulu.jpg', '2019-10-11', '2019-10-11 12:41:28'),
(2, 'Oprenario', 'Leslie Alexis', 'Manuel', '1990-03-31', 29, '23 E. Caruncho Avenue', 'Malinao', 'Pasig', 'Metro Manila', 'Philippines', 'Male', 'Teacher', '../pictures/employee/Diane_(Seven_Deadly_Sins).jpg', '2019-10-11', '2019-10-11 12:41:28'),
(3, 'Gabon', 'Carlos Miguel', 'Manuel', '2010-01-22', 9, '242 Marigold St', 'Pinagbuhatan', 'Pasig', 'Metro Manila', 'Philippines', 'Male', 'Teacher', '../pictures/employee/lulu.jpg', '2019-10-11', '2019-10-11 12:41:28'),
(4, 'Oprenario', 'Leslie Alexis', 'Manuel', '1990-03-31', 29, '23 E. Caruncho Ave,', 'Malinao', 'Pasig City', 'Metro Manila', 'Philippines', 'Male', 'Teacher', '../pictures/employee/401251_393070170706909_1000554163_n.jpg', '2019-10-11', '2019-10-11 12:41:28'),
...
INSERT INTO `sched_backup` (`SubjectID`, `SubjectTime`, `SubjectDay`, `DateCreated`) VALUES
...
INSERT INTO `section` (`SectionName`, `GradeLevel`, `RoomNum`, `SectionNum`, `DateCreated`) VALUES
...
--
DELIMITER $$
CREATE TRIGGER `AFTER INSERT student` AFTER INSERT ON `student` FOR EACH ROW INSERT INTO access(username, pass, access) VALUES(New.LRNNum, ENCODE("5678",'secret'), "student")
$$
DELIMITER ;
DELIMITER $$
...
INSERT INTO `student_backup` (`LRNNum`, `LastName`, `FirstName`, `MiddleName`, `Birthday`, `Age`, `StreetAdd1`, `StreetAdd2`, `City`, `Province`, `Country`, `Gender`, `GradeLevel`, `Type`, `URL_Picture`, `DateCreated`) VALUES
...
INSERT INTO `student_section` (`LRNNum`, `SectionNum`, `GradeLevel`, `DateCreated`) VALUES
...
--
DELIMITER $$
CREATE TRIGGER `backup student_section` BEFORE DELETE ON `student_section` FOR EACH ROW BEGIN
...
INSERT INTO `student_section_backup` (`LRNNum`, `SectionNum`, `GradeLevel`, `DateCreated`) VALUES
...
('26-SCI7A', 'SCI 7A', 26, 3, '2019-10-18 12:34:08'),
...
INSERT INTO `subject_backup` (`SubjectID`, `SubjectCode`, `SectionNum`, `EmployeeNum`, `DateCreated`) VALUES
...
--
ALTER TABLE `employee`
  MODIFY `EmployeeNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
