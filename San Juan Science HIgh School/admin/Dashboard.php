...
<body class="bg-light">
    ...
    <div class="my-container">
        <nav class="menu">
            <ul>
                <li><a href="" class="main-li"><i class="fas fa-home"></i>Home</a></li>
                <li><a href="" class="main-li"><i class="fas fa-desktop"></i>Dashboard</a>
                    <div class="sub-div">
                        <a class="sub-li active" href="">Overview</a>
                        <a class="sub-li" href="">Students</a>
                        <a class="sub-li" href="">Employees</a>
                        <a class="sub-li" href="">Schedules</a>
                        <a class="sub-li" href="">Subjects</a>
                        <a class="sub-li" href="">Sections</a>
                        <a class="sub-li" href="">Rooms</a>
                    </div>
                </li>
